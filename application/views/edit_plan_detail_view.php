...
<head>
    ...
    <body class="page-body  page-fade">
		...
		<form action="<?=base_url()?>edit_plan/update_plan" enctype="multipart/form-data" method="POST" role="form" class="form-horizontal form-groups-bordered">

			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Member ID :</label>					
					<div class="col-sm-5">
						<input type="text" name="member_id"  value="<?php echo $member_id; ?>" id="member_id" class="form-control"  data-rule-minlength="5" placeholder="member_id" maxlength="999" >
					</div>
			</div>
			<input name="plan_id" value="<?php echo $plan_id; ?>" class="form-control" type='hidden'/>
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Plan Type :</label>					
					<div class="col-sm-5">
						<input type="text" name="plan_type" id="textfield3" class="form-control" data-rule-required="true" data-rule-minlength="4" placeholder="Plan Type" maxlength="100">
					</div>
			</div>
    ...
    {
       echo '<option value="'.$trainer->trainer_id.'">'.$trainer->trainer_id.'-'.$trainer->name.'</option>';
    }
?>
</select> <br><br>
					</div>
			...
			<div class="form-group">
				<label for="field-1" class="col-sm-3 control-label">Rate :</label>					
					<div class="col-sm-5">
						<input type="text" name="rate" id="textfield6" class="form-control" data-rule-required="true" data-rule-minlength="10" placeholder="price"  placeholder="Rate"  onKeyPress="return checkIt(event)" maxlength="10">
					</div>
			</div>
